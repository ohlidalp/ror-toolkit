...
#				self.terraintoolbar.EnableTool(ID_StartRoR, False)
				...
				#self.terraintoolbar.AddSeparator()
				self.terraintoolbar.AddTool(ID_CopySelection, "Copy Selection", getBitmap("page_copy"))
#				self.terraintoolbar.EnableTool(ID_CopySelection, False)
				self.terraintoolbar.AddTool(ID_PasteSelection, "Paste Selection", getBitmap("page_paste"))
#				self.terraintoolbar.EnableTool(ID_PasteSelection, False)
				...
				#self.terraintoolbar.AddSeparator()
				self.terraintoolbar.AddTool(ID_FindObject, "go to...", getBitmap("find"), shortHelp="go to to some coordenates")
