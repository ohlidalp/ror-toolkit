...
class MainFrame(wx.Frame):
    ...
    def __init__(self, parent, id=-1, title="", pos=wx.DefaultPosition,
		...
		tb4 = wx.ToolBar(self, -1, wx.DefaultPosition, wx.DefaultSize, wx.TB_FLAT | wx.TB_NODIVIDER | wx.TB_HORZ_TEXT)
        ...
        self.ogrewin = RoRTerrainOgreWindow(self, wx.ID_ANY, rordir=self.rordir)
        self._mgr.AddPane(self.ogrewin, wx.aui.AuiPaneInfo().Name("html_content").
                          CenterPane())
    ...
    def OnOpenTerrain(self, event=None):
        ...
        if res == wx.ID_OK:
            ...
            self.ogrewin.LoadTerrain(filename)
