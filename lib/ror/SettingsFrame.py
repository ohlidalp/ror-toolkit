...
class MyDlg(wx.Dialog):
    def __init__(self,parent,id = -1,title = '',pos = wx.Point(0,0),size = wx.Size(440,375),style = wx.DEFAULT_DIALOG_STYLE,name = 'dialogBox'):
        pre=wx.PreDialog()
        self.OnPreCreate()
        pre.Create(parent,id,title,pos,size,wx.CAPTION|wx.RESIZE_BORDER|wx.SYSTEM_MENU|wx.CLOSE_BOX|wx.DIALOG_NO_PARENT|wx.MINIMIZE_BOX|wx.MAXIMIZE_BOX,name)
        self.PostCreate(pre)
        self.initBefore()
        self.VwXinit()
        self.initAfter()
    ...
    def VwXinit(self):
        ...
        self.panelBitmap = wx.Panel(self,-1,wx.Point(3,3),wx.Size(428,125))
        ...
        self.wxnb11c = wx.Notebook(self,-1,wx.Point(3,167),wx.Size(20,20))
        self.pn12c = wx.Panel(self.wxnb11c,-1,wx.Point(4,22),wx.Size(420,103))
        self.wxnb11c.AddPage(self.pn12c,'General Settings',0)
        ...
        self.wxnb11c.AddPage(self.pn21c,'Updates: 1',0)
        ...
        self.sz4s.Add(self.panelBitmap,0,wx.TOP|wx.LEFT|wx.BOTTOM|wx.RIGHT|wx.EXPAND|wx.FIXED_MINSIZE,3)
    ...
    def VwXpanelBitmap_VwXEvOnEraseBackground(self,event):
        self.VwXDrawBackImg(event,self.panelBitmap,self.panelBitmapImg0,0)
